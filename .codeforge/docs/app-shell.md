...
- **crates/tauri-app/frontend/src/main.tsx** — entry point, font registration, global event listener init, renders App into #app.
- **crates/tauri-app/frontend/src/stores/app-store.ts** — singleton SolidJS store holding all app state (contexts, sessions, features, timeline, UI flags).
